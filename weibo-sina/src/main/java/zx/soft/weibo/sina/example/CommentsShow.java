...
public class CommentsShow {
	...
	public static void main(String[] args) {
		//3194139109,3818214747,3442868347//3903363684666480
		...
		SinaDomain sinaDomain = api.commentsShow(cookie, "3905364770682830", "0", "0", 10, 1, 0, "3442868347");//3764456762795565//3885280807452287
		List<SinaDomain> sinaDomain2 = api.repostsShow(cookie, "3905364770682830", "0", "0", 10, 1, "603152360");
		System.out.println(JsonUtils.toJson(sinaDomain));
		System.out.println(JsonUtils.toJson(sinaDomain2.get(0)));
