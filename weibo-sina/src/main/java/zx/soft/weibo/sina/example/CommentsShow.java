...
public class CommentsShow {
	...
	public static void main(String[] args) {
		...
		SinaDomain sinaDomain = api.commentsShow(cookie, "3905441199698600", "0", "0", 10, 1, 0, "3442868347");//3764456762795565//3885280807452287
		SinaDomain sinaDomain2 = api.repostsShow(cookie, "3901125365375735", "0", "0", 10, 1, 0, "3818214747");
		System.out.println(JsonUtils.toJson(sinaDomain2));
